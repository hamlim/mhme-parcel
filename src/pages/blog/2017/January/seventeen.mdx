...
<aside>
  <p>
    Are these blog posts episodes? In some sense they are descriptions of my
    days which could be seen as a form of episode. 🤷🏼‍♂️
  </p>
</aside>
...
export default props => <Post date="01/17/2017" {...props} />
