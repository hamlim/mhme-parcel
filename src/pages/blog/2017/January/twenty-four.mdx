...
<aside>
  <p>
    Maybe I should start recording short audio versions of this episodic blog
    post series and just post that, or post that with some transcribed content
    as well.
  </p>
</aside>
...
export default props => <Post date="01/24/2017" {...props} />
