...
const October2016 = () => (
  <Fragment>
        ...
        r.match && (
          <Fragment>
            ...
            <ul>
              ...
              <li>
                <Link to={`${local}sunday-morning-recap-1`}>Sunday Morning Recap vol. 1</Link>
              </li>
              <li>
                <Link to={`${local}state-of-my-projects`}>State of My Projects</Link>
              </li>
              <li>
                <Link to={`${local}weekend-projects-6`}>Weekend Projects vol. 6</Link>
              </li>
              <li>
                <Link to={`${local}weekend-projects-7`}>Weekend Projects vol. 7</Link>
              </li>
              <li>
    ...
    <Route path={`${local}sunday-morning-recap-1`} component={SMR1} />
    <Route path={`${local}state-of-my-projects`} component={StateOfMyProjects} />
    <Route path={`${local}weekend-projects-6`} component={WeekendProjects6} />
    <Route path={`${local}weekend-projects-7`} component={WeekendProjects7} />
    <Route path={`${local}weekly-recap-5`} component={WeeklyRecap5} />
    <Route path={`${local}weekly-recap-6`} component={WeeklyRecap6} />
    <Route path={`${local}weekly-recap-7`} component={WeeklyRecap7} />
  </Fragment>
)
