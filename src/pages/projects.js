  ...
  <Container>
    ...
    >
      ...
      <Project>
        ...
        <Description>
          Extremely work in progress project to develop a single source of truth for design systems.
        </Description>
      </Project>
      <Project>
        <h4>
      ...
      <Project>
        ...
        <Description>
          This website is one of the largest time sinks for me. I consistently spend time testing out other techniques,
          tools, and technologies on this. Over the past two months I have dropped all work on anything else (outside of
          my actual job of course) to revamp this website.
        </Description>
      </Project>
      <Project>
        <h4>
        ...
        <Description>
          Future-Grid is a complete forward facing css grid system. It is built to support IE8 and up, and uses flexbox,
          and is also the first and only CSS Grid grid framework. I built this in the span of a short weekend as a test
          for myself and also as a way to learn more about CSS Grid.
        </Description>
      </Project>
      <Project>
        <h4>
        ...
        <Description>
          Goexploring.today is like my garage, its where I store all my side projects that I have worked on, I am in the
          process of moving some of the projects into their own domains but for now they all live on that domain.
        </Description>
      </Project>
      <Project>
        <h4>
      ...
      <Project>
        ...
        <Description>
          Dollar was one of my first full on projects. And to this date I still consider it as one of the most ambitious
          projects I have worked on by myself. It involved a lot of crappy JS when I first made it but I am working on
          refactoring it to use react and redux. I think at the moment of writing this it is extremely broken, but I
          plan on getting back to it after I polish off the rest of this website.
        </Description>
      </Project>
      <Project>
        <h4>
        ...
        <Description>
          ...
          places mainly because Dollar was more a fully functioning webapp. Bundles still works to this date, however it
          never really got to a place where I was comfortable with it. I ended up spending more and more time building
          out Dollar over Bundles.
        </Description>
      </Project>
    </ul>
  </Container>
